{ userSettings, ... }:
let path = with userSettings; "/home/${username}/.Xmodmap";
in {
  home.file."${path}" = {
    text = ''
      keycode   8 =
      ...
      keycode 191 = adiaeresis Adiaeresis adiaeresis Adiaeresis adiaeresis Adiaeresis
      keycode 192 = odiaeresis odiaeresis odiaeresis odiaeresis odiaeresis odiaeresis
      keycode 193 = udiaeresis udiaeresis udiaeresis udiaeresis udiaeresis udiaeresis
      keycode 194 = ssharp ssharp ssharp ssharp ssharp ssharp
      ...
      keycode 202 =
      keycode 203 = ISO_Level5_Shift NoSymbol ISO_Level5_Shift NoSymbol ISO_Level5_Shift
      ...
      keycode 252 = XF86BrightnessAuto NoSymbol XF86BrightnessAuto NoSymbol XF86BrightnessAuto
      keycode 253 = XF86DisplayOff NoSymbol XF86DisplayOff NoSymbol XF86DisplayOff
